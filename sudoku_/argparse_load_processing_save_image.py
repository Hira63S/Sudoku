...
parser.add_argument("C:\Users\Billi\repos\sudoku\tesla.png", help="path to input image to be displayed")

# Add 'path_image_output' argument using add_argument() including a help. The type is string (by default):
parser.add_argument("C:\Users\Billi\repos\sudoku\tesla.png", help="path of the processed image to be saved")

# Parse the argument and store it in a dictionary:
args = vars(parser.parse_args())

# We can load the input image from disk:
image_input = cv2.imread(args["C:\Users\Billi\repos\sudoku\tesla.png"])
